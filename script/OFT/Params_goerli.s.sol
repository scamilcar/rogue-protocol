...
contract Params_goerli is Script {
    ...
    function run() external {
        ...
        bytes memory _path = abi.encodePacked(address(lockerBsc), (lockerGoerli));
        // set trusted params
        lockerGoerli.setTrustedRemote(bscTestnetChainId, _path);
        // set min gas for bsc testnet
        lockerGoerli.setMinDstGas(bscTestnetChainId, uint16(0), uint(100000));
